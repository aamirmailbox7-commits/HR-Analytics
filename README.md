...
📋 Project Overview
This project transforms raw HR data into a strategic decision-making tool. Unlike standard descriptive reports, this dashboard utilizes Predictive Analytics to identify high-value talent at risk, evaluate recruitment ROI by source, and audit internal pay equity.
...
Flight Risk Flag: Used nested IF(AND(...)) logic to automatically flag high-performers with low satisfaction and below-average salary.

Gender Pay Gap: Utilized AVERAGEX to iterate across filtered tables to ensure the $3K gap wasn't skewed by outliers.
...
Dataset: HRDataset_v14.xlsx📊 HR People Analytics: Strategic Workforce Insights Dashboard
📋 Project Overview
This project transforms raw HR data into a strategic decision-making tool. Unlike standard descriptive reports, this dashboard utilizes Predictive Analytics to identify high-value talent at risk, evaluate recruitment ROI by source, and audit internal pay equity.
